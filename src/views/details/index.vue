    ...
    <div class="info-container">
      <div>
        <div class="goods-info">
          <div class="media">
            <!-- 图片预览区 -->
            <XtxImageView :imageList="imgList" />
            ...
            <div class="goods-tabs">
              ...
              <div class="goods-detail">
                ...
                <el-descriptions :column="2" border>
                  <el-descriptions-item v-for="item in goods.details?.properties" :key="item.name" :label="item.name">{{ item.value }}</el-descriptions-item>
                </el-descriptions>
                <!-- 图片 -->
...
const imgList = ref([])
onMounted(() => {
  getGoodsDetailAPI(route.params.id).then(res => {
    // console.log(res)
